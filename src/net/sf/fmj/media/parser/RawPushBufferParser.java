...
/**
 * Demux that doesn't really do much - since the stream does all the work of providing the buffers.
...
public class RawPushBufferParser extends AbstractDemultiplexer 
{
	...
	private static final int POLL_INTERVAL = 1000;	// how often to wake up and read anyway, even if not notified by handler.  Kind of an insurance policy.
