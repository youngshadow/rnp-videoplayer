...
//		 TODO: disconnect source?
	...
	public void open() throws IOException, SecurityException
	{
		...
		final RandomAccessFile f = new RandomAccessFile(path, "rw");	// TODO: ensure closed even if start/stop never called.
		...
		writerThread = new WriterThread(source.getStreams()[0], f);	// TODO other tracks?
	...
	private class WriterThread extends CloseableThread implements SourceTransferHandler, Seekable
	{
		...
		public void run()
		{
			...
			catch (IOException e)
			{
				...
				notifyDataSinkListeners(new DataSinkErrorEvent(Handler.this, e.getMessage()));
