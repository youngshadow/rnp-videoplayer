...
public class Handler extends AbstractDataSink
{
	...
	private SendStream[] streams;	// array will be same size as number of source streams, but entries will be null if not being transmitted.
	...
	public void open() throws IOException, SecurityException
	{
		...
		{
			logger.log(Level.WARNING, "" + e, e);		// TODO: should this be in setDataSource()? should we really rethrow this as IOException?
			throw new IOException("" + e);
		}
