...
public class JavaOggParser extends AbstractDemultiplexer 
{
	...
	public void close()
	{
		...
		synchronized (OGG_SYNC_OBJ)
		{
			...
			resetVars();	// this will prevent vi.clear from being called twice, which can cause an NPE
		}
		super.close();
	}
...
//	}
    ...
    {
		return new AudioFormat(AudioFormat.LINEAR, (float) vi.rate, 16, vi.channels, AudioFormat.LITTLE_ENDIAN, AudioFormat.SIGNED);
    }
