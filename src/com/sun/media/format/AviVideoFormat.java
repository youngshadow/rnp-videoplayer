...
public class AviVideoFormat extends VideoFormat
{
	...
	public Object clone()
	{
		return new AviVideoFormat(encoding, size, maxDataLength, dataType, frameRate, 
				planes, bitsPerPixel, imageSize, xPelsPerMeter, yPelsPerMeter, clrUsed, clrImportant, codecSpecificHeader);

	}
	protected void copy(Format f)
	{
		super.copy(f);
		final AviVideoFormat oCast = (AviVideoFormat) f;	// it has to be a WavAudioFormat, or ClassCastException will be thrown.
	...
	public boolean matches(Format format)
	{
		...
		return 
			FormatUtils.matches(this.planes, oCast.planes) &&
