...
{	
	// It looks like Sun's implementation might delegate this (via reflection) to javax.media.cdm.CaptureDeviceManager, which has synchronized methods.
	...
	private static synchronized boolean init()
	{
		...
		try
		{
			...
			addDeviceMethod = getStaticMethodOnImplClass("addDevice", new Class[]{CaptureDeviceInfo.class}, boolean.class);
			removeDeviceMethod = getStaticMethodOnImplClass("removeDevice", new Class[]{CaptureDeviceInfo.class}, boolean.class);
