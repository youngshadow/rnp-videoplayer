...
public class H263Format extends VideoFormat
{
	...
	public boolean matches(Format format)
	{
		...
		final boolean result = 
			FormatUtils.matches(this.advancedPrediction, oCast.advancedPrediction) &&
	...
	public Object clone()
	{
		return new H263Format(FormatUtils.clone(size), maxDataLength, dataType, frameRate,
				advancedPrediction, arithmeticCoding, errorCompensation, hrDB,
				pbFrames, unrestrictedVector);
	}

	protected void copy(Format f)
	{
		super.copy(f);
		final H263Format oCast = (H263Format) f;	// it has to be a H263Format, or ClassCastException will be thrown.
		this.advancedPrediction = oCast.advancedPrediction;
		this.arithmeticCoding = oCast.arithmeticCoding;
		this.errorCompensation = oCast.errorCompensation;
		this.hrDB = oCast.hrDB;
