...
//	{
	    ...
	    public static final int AM_SEEKING_AbsolutePositioning  = 0x01;     // Position is supplied and is absolute
	    public static final int AM_SEEKING_RelativePositioning  = 0x02;     // Position is supplied and is relative
	    public static final int AM_SEEKING_IncrementalPositioning   = 0x03; // (Stop) position relative to current
	                                                // Useful for seeking when paused (use +1)
	    public static final int AM_SEEKING_PositioningBitsMask  = 0x03;     // Useful mask
	    public static final int AM_SEEKING_SeekToKeyFrame       = 0x04;     // Just seek to key frame (performance gain)
	    public static final int AM_SEEKING_ReturnTime           = 0x08;     // Plug the media time equivalents back into the supplied LONGLONGs

	    public static final int AM_SEEKING_Segment              = 0x10;     // At end just do EC_ENDOFSEGMENT,
...
//	{
    	...
    	public static final int AM_SEEKING_Source              = 0x100;  // Doesn't pass thru used to
	                                            // count segment ends
