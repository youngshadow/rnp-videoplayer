...
abstract class AbstractControls implements ControllerListener {
	...
	setControlComponentState(player.getState());	// KAL: added because there seems to be a race condition where the player can change states before our listener gets registered.
    }
