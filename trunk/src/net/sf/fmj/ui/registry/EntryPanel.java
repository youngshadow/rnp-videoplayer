...
/**
 * Can be used for adding entries to:
 * 	- plugins, demuxes, codecs, effects, renderers, muxes
 * 	- content package prefixes
 * 	- protocol package prefixes
 * 
	...
	private void removeEntry(String entry) {
		...
		switch(type) {
			...
			case TYPE_MIME_TYPES:
				...
				// this code will not actually remove default extensions, but no warning is given.
		...
		if (entryList == null) {
			...
			entryList.addListSelectionListener(new ListSelectionListener() {
				...
				public void valueChanged(ListSelectionEvent e)
				{
					...
					//logger.fine("e.getValueIsAdjusting()=" + e.getValueIsAdjusting() + "first=" + e.getFirstIndex() + "; last=" + e.getLastIndex() + "; index=" + entryList.getSelectedIndex() + "; o=" + entryList.getSelectedValue());
