...
/**
 * This Renderer is used to log process() calls.  Useful for diagnosing
 * whether the Renderer is actually being told to process buffers. 
 * 
...
public class DiagnosticVideoRenderer implements Renderer {
	...
	Format[] supportedFormats = new Format[] {
			new RGBFormat(),
			new YUVFormat(),
	};
