 ...
 * Used for badly behaving input streams where available() is not working right or useless.
 * @author Ken Larson
 *
 */
public class InputStreamReader extends InputStream
{
	...
	private static class ReaderThread extends CloseableThread
	{
		...
		public ReaderThread(final ProducerConsumerQueue emptyQueue, final ProducerConsumerQueue fullQueue, final InputStream is, final int bufferSize)
		{
			super();
