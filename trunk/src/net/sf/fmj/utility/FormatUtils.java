...
//	}	
	...
	{	if (v1 == (float) Format.NOT_SPECIFIED || v2 == (float) Format.NOT_SPECIFIED)
			return true;
		return v1 == v2;
	}	
	public static boolean matches(double v1, double v2)
	{	if (v1 == (double) Format.NOT_SPECIFIED || v2 == (double) Format.NOT_SPECIFIED)
			return true;
		return v1 == v2;
	}	
...
//	}
	...
	public static void traceRelax(Format f1, Format result)
	{
		...
		System.out.println("assertEquals(" + MediaCGUtils.formatToStr(f1) + ".relax(), " + MediaCGUtils.formatToStr(result) + ");");
	}
...
//				
//				if (fCast1.getSize() != null && fCast1.getSize().equals(fCastResult.getSize()) && fCast1.getSize() != fCastResult.getSize())
...
//				VideoFormat fCastResult = (VideoFormat) result;
//				
//				if (fCast1.getSize() != null && fCast1.getSize() == fCastResult.getSize())
...
//	}
	...
	public static void traceIntersects(Format f1, Format f2, Format result)
	{
		if (!TRACE)
			return;
		System.out.println("assertEquals(" + MediaCGUtils.formatToStr(f1) + ".intersects(" + MediaCGUtils.formatToStr(f2) + "), " + MediaCGUtils.formatToStr(result) + ");");
...
//		checkSizeNotCloned(f2, result);
	...
	public static void traceMatches(Format f1, Format f2, boolean result)
	{
		if (!TRACE)
			return;
		System.out.println("assertEquals(" + MediaCGUtils.formatToStr(f1) + ".matches(" + MediaCGUtils.formatToStr(f2) + "), " + result + ");");
	}
	...
	public static void traceEquals(Format f1, Format f2, boolean result)
	{
		if (!TRACE)
			return;
		//System.out.println("assertEquals(" + MediaCGUtils.formatToStr(f1) + ".equals(" + MediaCGUtils.formatToStr(f2) + "), " + result + ");");
	}
	...
	public static void traceClone(Format f1, Format f2)
	{
		if (!TRACE)
			return;
		System.out.println("assertEquals(" + MediaCGUtils.formatToStr(f1) + ".clone(), " + MediaCGUtils.formatToStr(f2) + ");");
