...
public abstract class FilterGraphNode
{
	 ...
	 * Destination nodes.
	 */
	private List/*<FilterGraphLink>*/ destLinks = new ArrayList/*<FilterGraphLink>*/();
	
	// processing state:
	/**
	 * Output buffer n is for destination node n.
	 * For a node which is a renderer node, the corresponding buffer will be null.
	 * Also, if a particular track/dest is not being processed at all by a graph,
	 * the corresponding buffer will be null.
	 */
