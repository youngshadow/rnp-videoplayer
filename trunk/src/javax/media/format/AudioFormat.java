...
//		dolbyac3, 2.0 Hz, 1-bit, 3-channel, Unsigned, 6.0 frame rate, FrameSize=5 bits
	...
	{	
		...
		{	
			if (getClass() == FormatUtils.audioFormatClass) FormatUtils.traceMatches(this, format, false); // otherwise let subclass trace
			return false;
		}
		...
		{	
			...
			if (getClass() == FormatUtils.audioFormatClass) FormatUtils.traceMatches(this, format, result);
			return result;
		}
		...
		if (getClass() == FormatUtils.audioFormatClass) FormatUtils.traceMatches(this, format, result); // otherwise let subclass trace
	...
	{	
		...
		if (getClass() == FormatUtils.audioFormatClass) FormatUtils.traceIntersects(this, other, result);
